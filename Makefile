...
CFLAGS = -g -O2 -DLXDM_XCONN_XCB
CONSOLEKIT_CFLAGS = -I/usr/include/ConsoleKit/ck-connector -I/usr/include/dbus-1.0 -I/usr/lib/i386-linux-gnu/dbus-1.0/include  
...
LIBOBJS = 
LIBS = -lck-connector -lpam -lcrypt 
LTLIBOBJS = 
MAKEINFO = makeinfo
MKDIR_P = /bin/mkdir -p
...
XLIB_LIBS = -lX11  
XMKMF = 
abs_builddir = /home/carlo/Documenti/paperino2/lxdm-0.5.0
abs_srcdir = /home/carlo/Documenti/paperino2/lxdm-0.5.0
abs_top_builddir = /home/carlo/Documenti/paperino2/lxdm-0.5.0
abs_top_srcdir = /home/carlo/Documenti/paperino2/lxdm-0.5.0
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/carlo/Documenti/paperino2/lxdm-0.5.0/install-sh
...
top_srcdir = .
NULL = 
SUBDIRS = src po data $(NULL) $(am__append_1) $(am__append_2)
EXTRA_DIST = \
	ChangeLog \
	AUTHORS \
	README \
...
lxdm.spec: $(top_builddir)/config.status $(srcdir)/lxdm.spec.in
